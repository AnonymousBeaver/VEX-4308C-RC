...
#pragma config(Motor,  port6,           frightMotor,   tmotorServoContinuousRotation, openLoop, reversed)
#pragma config(Motor,  port9,           fleftMotor,    tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port3,           intakeMotor,   tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port7,           middleMotor,   tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port4,           rshooterMotor, tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port8,           lshooterMotor, tmotorVex393TurboSpeed_MC29, openLoop)
