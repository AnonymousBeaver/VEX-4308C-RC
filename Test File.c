...
#pragma config(Motor,  port4,           ShooterMotor1, tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port5,           ShooterMotor2, tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           ShooterMotor3, tmotorVex393TurboSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port7,           ShooterMotor4, tmotorVex393TurboSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           RearLeft,      tmotorVex393_MC29, openLoop)
