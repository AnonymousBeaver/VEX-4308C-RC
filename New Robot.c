...
#pragma config(Motor,  port4,           RearLeft,      tmotorVex393_MC29, openLoop, driveLeft)
#pragma config(Motor,  port5,           RearRight,     tmotorVex393_MC29, openLoop, driveRight)
#pragma config(Motor,  port6,           intake,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           ShooterMotor1, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           ShooterMotor2, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           ShooterMotor3, tmotorVex393_MC29, openLoop)
...
task servo1Control()
{
	...
	while (true)
	{
		if (servo1Degrees != currentDegrees)
		{
			motor[Servo1] = servo1Degrees;
			wait1Msec(100);
		}
	}
}
...
task joystickMonitor()
{
	while(true)
	{
		...
		short left = (short)(float)(vexRT[vexJSRightV] + vexRT[vexJSRightH])*scale;
...

{
	while(true)
	{
		if (vexRT[Btn6D] ==1)
		{
			...
			motor[ShooterMotor2]= -127;
			motor[ShooterMotor3]= -127;
		}
